...
class BaseDataFeed(object):
    ...
    def get_data(self):
        ...
        price_data = DataReader(self.tickers, "stooq", self.start_date, self.end_date)[
            "Close"
        ]
    ...
    def _preprocess(self, price_data):
        ...
        return (
            ...
            .rename(columns={"level_0": "date", "Symbols": "ticker"})
        )
...
# %%
data = BaseDataFeed(
    tickers=["AAPL", "MSFT", "GOOG"], start_date="2017-01-01", end_date="2017-12-31"
)
data.data.head()
# %%
